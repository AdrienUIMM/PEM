//-------------------------------------
//Script créé : May 05, 2023 - MODIFIÉ
//
// Description : Validation des paramètres avec gestion des masques de capteurs
//
//-------------------------------------
boolean erreur;
erreur = false;
...
//Modified pour supporter les masques de capteurs
//
// Description :
//
//-------------------------------------
...
//********************************************************
// Gestion de l'enregistrement des masques de capteurs par type de contrôle
//********************************************************
if(typeCtrl == 1)
{
	_Reference.Reference_CapteursMask_Normal.write(MasqueCapteursActuel.getIntValue());
}
else if(typeCtrl == 2)
{
	_Reference.Reference_CapteursMask_Double.write(MasqueCapteursActuel.getIntValue());
}
else if(typeCtrl == 3)
{
	_Reference.Reference_CapteursMask_Partiel.write(MasqueCapteursActuel.getIntValue());
}
